...
module OCI
  ...
  class Identity::Models::BaseTagDefinitionValidator
    ...
    def self.get_subtype(object_hash)
      type = object_hash[:'validatorType'] # rubocop:disable Style/SymbolLiteral

      return 'OCI::Identity::Models::DefaultTagDefinitionValidator' if type == 'DEFAULT'
      return 'OCI::Identity::Models::EnumTagDefinitionValidator' if type == 'ENUM'
    ...
    # @option attributes [String] :validator_type The value to assign to the {#validator_type} property
    def initialize(attributes = {})
      ...
      self.validator_type = attributes[:'validatorType'] if attributes[:'validatorType']

      raise 'You cannot provide both :validatorType and :validator_type' if attributes.key?(:'validatorType') && attributes.key?(:'validator_type')

      self.validator_type = attributes[:'validator_type'] if attributes[:'validator_type']
    end
